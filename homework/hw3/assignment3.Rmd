...
# 3.6.3 Multiple Linear Regression (page 114) 
fit1 = lm(math ~ ., data = data)
summary(fit1)
fit1
...
# We can use the library psych to create a more interesting plot.
library(psych)
pairs.panels(data)


fit2 = lm(math ~ data$income, data)
summary(fit2)
summary(fit2)$r.sq
summary(fit2)$sigma
